 ...
 */
@Entity
@Table(name = "dublino_en")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DublinoEn.findAll", query = "SELECT d FROM DublinoEn d")
    , @NamedQuery(name = "DublinoEn.findByCorso", query = "SELECT d FROM DublinoEn d WHERE d.corso = :corso")})
public class DublinoEn implements Serializable {
    ...
    public DublinoEn(Integer corso) {
        this.corso = corso;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DublinoEn)) {
            return false;
        }
        DublinoEn other = (DublinoEn) object;
    ...
    public String toString() {
        return "prova.DublinoEn[ corso=" + corso + " ]";
    }
