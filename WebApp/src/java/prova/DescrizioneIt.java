 ...
 */
@Entity
@Table(name = "descrizione_it")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DescrizioneIt.findAll", query = "SELECT d FROM DescrizioneIt d")
    , @NamedQuery(name = "DescrizioneIt.findByCorso", query = "SELECT d FROM DescrizioneIt d WHERE d.corso = :corso")})
public class DescrizioneIt implements Serializable {
    ...
    public DescrizioneIt() {
    }

    public DescrizioneIt(Integer corso) {
        this.corso = corso;
    }

    public DescrizioneIt(Integer corso, String prerequisiti, String modEsame, String modInsegnamento, String sillabo) {
        this.corso = corso;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DescrizioneIt)) {
            return false;
        }
        DescrizioneIt other = (DescrizioneIt) object;
    ...
    public String toString() {
        return "prova.DescrizioneIt[ corso=" + corso + " ]";
    }
