...
public class StreamResult {
    ...
    public void activate(URL resource, HttpServletRequest request, HttpServletResponse response) throws IOException {
        URLConnection connection = resource.openConnection();
        String url = resource.toString();
        activate(connection.getInputStream(), connection.getContentLength(), url.substring(url.lastIndexOf('/') + 1), request, response);
    }
